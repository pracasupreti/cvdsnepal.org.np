...
<html lang="en">
  <head>
    ...
    <title>About Us | Conflict Victim and Disable Society | Nepal</title>
    <meta name="keywords" content="CVDS,about Conflict Victim and Disable Society,about cvds nepal,cvds,non profit social organization,social organization,organization that enhance disable person"/>
    <meta name="description" content="Conflict Victim and Disable Society Nepal is a non profit social organization established in 2005 with a mission to enhance and uplift the livelihood of conflict victims."/>
  ...
  <body>
    ...
    <div data-header="sticky" data-header-top="200" data-canvas="container" class="l-theme animated-css header-demo">
      ...
      <section class="typography-section__inner">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <h2 class="typography-title">Welcome to CVDS Nepal</h2>
                  <div class="row">
                    <div class="col-md-12">

                      <p class="dropcap dropcap_primary">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <h4 class="typography-title">Vision</h4>
                      <p class="dropcap dropcap_secondary typography-dropcap">
                      Children with disability due to Cerebral Palsy by making them capable enough to lead an independent life thereby mainstreaming them towards national development.<br><br><br></p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              ...
              <h2 class="ui-title-block"><span class="text-primary"> Mission</span></h2>
              <p>The mission of CVDS is to create pathways for the progressive removal of societal bias and the negative stereotypes that exist today.</p>
              
                <ul class="list list-mark-1 ">
                    <li >To overshadow the prejudice prevalent in Nepal regarding the image of psychiatrist disabled people and hence provide equal opportunities for them till they live.</li>
                    <li>To motivate and involve disabled and conflict victims in various  activities by giving them knowledge about dancing, music, toileting, art, and formal education.</li>
                    <li>For the benefit of the kids, programs relating to personality development of the target groups will be conducted by a medical practitioner, caregiver, therapist, teacher, and administrative personnel.</li>
                </ul>
            ...
            <br><br>
              <div class="progress-block-group">
                <div class="progress-block">
                  <div class="progress__title">Protection</div>
...
-->
      ...
      <section class="typography-section__inner">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <h2 class="typography-title">About Chiarman: </h2>
                  <div class="row">
                    <div class="col-md-12">
...
Facebook: cvdsnepal/yubraj thapa bairagi
 <br><br></p>
    ...
    <!-- <script src="assets/libs/jquery-1.12.4.min.js"></script> hide slider-->
