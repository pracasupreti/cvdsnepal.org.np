...
<html lang="en">
  <head>
    ...
    <title>Project | Conflict Victim and Disable Society | Nepal</title>
    <meta name="keywords" content="project of cdvs nepal,events of cdvs nepal" />
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                ...
                <h1 class="b-title-page__title">Project</h1>
                <ol class="breadcrumb">
...
<!--                <h2 class="typography-title">Tables</h2>-->
                ...
                <p class="typography__highlights"><span class="text-bg bg-border">Note: CVDS-Nepal has prioritized socially marginalized, backward caste, women and extremely poor conflict victim & pwd’s groups for its entrepreneurship training program:</span> </p>
