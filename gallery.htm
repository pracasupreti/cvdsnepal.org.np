...
<html lang="en">
  <head>
    ...
    <title>Gallery | Conflict Victim and Disable Society | Nepal</title>
    ...
    <div data-header="sticky" data-header-top="200" data-canvas="container" class="l-theme animated-css header-demo">
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                ...
                <h1 class="b-title-page__title">Gallery</h1>
                <ol class="breadcrumb">
      ...
      <section class="typography-section__inner">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <h1 class="typography-title" style="text-align:center;">Gallery</h1>
                  <div class="row">
                    <div class="col-md-12">
        ...
        <div id="flickrembed"></div><div style="position:absolute; top:-70px; display:block; text-align:center; z-index:-1;"><a href="https://www.youtubevideoembed.com">https://www.youtubevideoembed.com</a></div><small style="display: block; text-align: center; margin: 0 auto;">Powered by <a href="https://flickrembed.com">flickr embed</a>.</small><script src='https://flickrembed.com/embed_v2.js.php?source=flickr&layout=responsive&input=www.flickr.com/photos/pracasinfosys/albums/72157687758284073&sort=3&by=album&theme=default&scale=fill&limit=29&skin=default&autoplay=true'></script>
