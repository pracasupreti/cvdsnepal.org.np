...
<html lang="en">
  <head>
    ...
    <title>Present | Conflict Victim and Disable Society | Nepal</title>
    ...
    <div data-header="sticky" data-header-top="200" data-canvas="container" class="l-theme animated-css header-demo">
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12">
                ...
                <h1 class="b-title-page__title">Present</h1>
                <ol class="breadcrumb">
                  <li><a href="index.php">Home</a></li>
                  <li class="active">Present</li>
                  <li><span class="text-second"><a href="pipeline.php" >Pipeline</a></span></li>
                </ol>
                <!-- end breadcrumb-->
              </div>
            </div>
      ...
      <section class="typography-section__inner">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <h2 class="typography-title">Present</h2>
                  <div class="row">
                    <div class="col-md-12">

                      <p class="dropcap dropcap_primary">
                        Present activities (self employment scheme)<br>
                        <br></p>
                        <p>
                        ...
                        <ul class="list list-mark-4 typography-last-elem">
                            <li>Handicraft( Paper production and Paper craft)</li>
